    ...
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          <img src={Image1} alt="basic_img" className="pricing__img" />
        ...
        <div className="pricing__item best">
          ...
          <img src={Image2} alt="premium_img" className="pricing__img" />
        ...
        <div className="pricing__item">
          <img src={Image3} alt="ultimate_img" className="pricing__img" />
